...
public class MenuUtils {
	...
	public static final Map<String, String> createDataStructureMenu() {
	...
	public static final Map<String, String> createGameBoardMenu() {
		Map<String, String> menu = new HashMap<>();
		menu.put("1", "Add Disc");
	...
	public static final Map<String, String> createColorDiscMenu() {
		Map<String, String> menu = new HashMap<>();
		menu = new HashMap<>();
